      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div className="space-y-2">
            <label htmlFor="invite-name" className="block text-xs font-bold uppercase tracking-widest text-zinc-400">
              Full Name
            </label>
            <input
              id="invite-name"
          ...
          <div className="space-y-2">
            <label htmlFor="invite-email" className="block text-xs font-bold uppercase tracking-widest text-zinc-400">
              Email
            </label>
            <input
              id="invite-email"
          ...
          <div className="space-y-2">
            <label htmlFor="invite-password" className="block text-xs font-bold uppercase tracking-widest text-zinc-400">
              Password
            </label>
            <input
              id="invite-password"
          ...
          <div className="space-y-2">
            <label htmlFor="invite-confirm" className="block text-xs font-bold uppercase tracking-widest text-zinc-400">
              Confirm Password
            </label>
            <input
              id="invite-confirm"
